                            ...
                            <li style="border-bottom: 1px solid #eee; padding: 10px 0; display: flex; justify-content: space-between; align-items: center;">
                                <div>
                                    <?php 
                                        ...
                                        if($mat['type']=='audio') $icon = '🎧';
                                    ?>
                                    <span style="font-size: 1.2rem; margin-right: 10px;"><?= $icon ?></span>
                                    <b><?= $mat['title'] ?></b>
                                </div>
                                <a href="index.php?page=learning&material_id=<?= $mat['id'] ?>" class="btn btn-primary" style="padding: 5px 15px; font-size: 0.8rem;">
                                    Mulai Belajar
                                </a>
                            </li>
                        <?php endforeach; ?>
                        ...
                        <div style="margin-top: 15px; border-top: 2px dashed #eee; padding-top: 15px;">
                            ...
                            <?php while($k = mysqli_fetch_assoc($q_kuis)): ?>
                                <?php 
                                    ...
                                    $sudah_kerja = cekStatusKuis($koneksi, $_SESSION['user_id'], $k['id']);
                                ?>
                                ...
                                <div style="display: flex; justify-content: space-between; align-items: center; margin-top: 8px; background: #f9f9f9; padding: 10px; border-radius: 8px; border: 1px solid #eee;">
                                    ...
                                    <div style="display: flex; align-items: center; gap: 10px;">
                                        ...
                                        <span style="font-weight: 500;"><?= $k['title'] ?></span>
                                    ...
                                    <?php if($sudah_kerja): ?>
                                        <a href="index.php?page=take_quiz&quiz_id=<?= $k['id'] ?>" 
                                           class="btn" 
        ...
        <div style="flex: 1; min-width: 250px;">
            <div class="card" style="position: sticky; top: 20px;">
                ...
                <?php 
                    ...
                    $persen = hitungPersentaseProgress($koneksi, $_SESSION['user_id'], $course['id']);
                ...
                <a href="index.php?page=student_transcript&course_id=<?= $course['id'] ?>" 
                   class="btn btn-block" 
